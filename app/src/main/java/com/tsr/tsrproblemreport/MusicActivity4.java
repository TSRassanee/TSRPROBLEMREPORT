...
import com.tsr.tsrproblemreport.fragment.HomeFragment4;
import com.tsr.tsrproblemreport.fragment.LibraryFragment7;
import com.tsr.tsrproblemreport.fragment.LibraryFragment8;
import com.tsr.tsrproblemreport.fragmentIconTextTab.IconTextTabsActivity1;
import com.tsr.tsrproblemreport.fragmentIconTextTab.IconTextTabsActivity4;
import com.tsr.tsrproblemreport.other.CircleTransform;
import com.tsr.tsrproblemreport.recycleviewuser.UI_CARDVIEW_LINE_USER;

import static com.tsr.tsrproblemreport.R.id.profile_name;

public class MusicActivity4 extends AppCompatActivity {
    ...
    String namethai="",picture="",backgroud="",salemanager="",name_salemanager="",username="",position="",status="",Date_issue="",logo="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment = new IconTextTabsActivity4();
        ...
        if(data!=null) {
            ...
            salemanager = data.getString("salemanager");
            name_salemanager = data.getString("name_salemanager");
            username = data.getString("username");

            urlProfileImg=picture;
            urlNavHeaderBg=backgroud;

            ManageSharedPreferences.SavePreferences(MusicActivity4.this,getLocalClassName(),"username",username);
            ManageSharedPreferences.SavePreferences(MusicActivity4.this,getLocalClassName(),"namethai",namethai);
            ManageSharedPreferences.SavePreferences(MusicActivity4.this,getLocalClassName(),"position",position);
            ManageSharedPreferences.SavePreferences(MusicActivity4.this,getLocalClassName(),"picture",picture);
            ManageSharedPreferences.SavePreferences(MusicActivity4.this,getLocalClassName(),"backgroud",backgroud);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    ...
                    fragment = new UI_CARDVIEW_LINE_USER();
                } else if (id == R.id.nav_report1) {
                    fragment = new LibraryFragment7();
                } else if (id == R.id.nav_report2) {
                    fragment = new LibraryFragment8();
                ...
                builder.setMessage("�س��ͧ��÷����͡�ҡ�к�? ")
                        ...
                        .setPositiveButton("��", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ManageSharedPreferences.SavePreferences(MusicActivity4.this, UI_LOGIN.NOTI_ADD, UI_LOGIN.LOGINUSER, "");
                                ManageSharedPreferences.SavePreferences(MusicActivity4.this, UI_LOGIN.NOTI_ADD, UI_LOGIN.LOGINPASS, "");
                ...
                builder.setMessage("Are you sure you want to logout?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Intent Mintent = new Intent(MusicActivity4.this, UI_LOGIN.class);
