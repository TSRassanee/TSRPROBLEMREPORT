package com.tsr.tsrproblemreport.recycleviewno;
...
public class UI_CARDVIEW_SALELEADER_NO extends Fragment {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/saleleader_no.php";
    ...
    public void JSON_DATA_WEB_CALL(){
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?name="+ ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity2.class.getSimpleName(), "username"),
