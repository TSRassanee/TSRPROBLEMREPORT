...
public class UI_CARDVIEW_SALE_NO extends Fragment {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/sale_no.php";
    ...
    public void JSON_DATA_WEB_CALL(){
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?name="+ ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity.class.getSimpleName(), "username"),
