...
public class UI_CARDVIEW_DEPART_NO extends Fragment {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/depart_no.php";
    ...
    public void JSON_DATA_WEB_CALL(){
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?name="+ ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity5.class.getSimpleName(), "username"),
