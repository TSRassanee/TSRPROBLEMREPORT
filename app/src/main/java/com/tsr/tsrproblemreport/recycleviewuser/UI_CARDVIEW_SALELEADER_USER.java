...
public class UI_CARDVIEW_SALELEADER_USER extends Fragment {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/prolem_user_all_saleleader.php";
