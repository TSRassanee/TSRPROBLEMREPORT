 ...
 */
public class ServerImageParseAdapter_USER {

    public static ServerImageParseAdapter_USER SIAdapter;
    ...
    private ServerImageParseAdapter_USER(Context context) {
    ...
    public static ServerImageParseAdapter_USER getInstance(Context SynchronizedContext) {

        if (SIAdapter == null) {

            SIAdapter = new ServerImageParseAdapter_USER(SynchronizedContext);
        }
        return SIAdapter;
    }
