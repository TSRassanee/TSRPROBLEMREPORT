 ...
 */
public class ServerImageParseAdapter_TIMELINE2 {

    public static ServerImageParseAdapter_TIMELINE2 SIAdapter;
    ...
    private ServerImageParseAdapter_TIMELINE2(Context context) {
    ...
    public static ServerImageParseAdapter_TIMELINE2 getInstance(Context SynchronizedContext) {

        if (SIAdapter == null) {

            SIAdapter = new ServerImageParseAdapter_TIMELINE2(SynchronizedContext);
        }
        return SIAdapter;
    }
