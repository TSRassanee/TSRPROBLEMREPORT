 ...
 */
public class ServerImageParseAdapter_TIMELINE {

    public static ServerImageParseAdapter_TIMELINE SIAdapter;
    ...
    private ServerImageParseAdapter_TIMELINE(Context context) {
    ...
    public static ServerImageParseAdapter_TIMELINE getInstance(Context SynchronizedContext) {

        if (SIAdapter == null) {

            SIAdapter = new ServerImageParseAdapter_TIMELINE(SynchronizedContext);
        }
        return SIAdapter;
    }
