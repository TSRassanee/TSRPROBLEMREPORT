...
import com.tsr.tsrproblemreport.adapterscollview.CustomFragmentPageAdapterScollview2;

public class IconTextTabsActivity2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new CustomFragmentPageAdapterScollview2(getChildFragmentManager()));
