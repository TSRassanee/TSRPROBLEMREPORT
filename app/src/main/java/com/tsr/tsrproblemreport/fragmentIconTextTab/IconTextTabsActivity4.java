...
import com.tsr.tsrproblemreport.adapterscollview.CustomFragmentPageAdapterScollview4;

public class IconTextTabsActivity4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new CustomFragmentPageAdapterScollview4(getChildFragmentManager()));
