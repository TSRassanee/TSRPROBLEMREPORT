...
import com.tsr.tsrproblemreport.adapterscollview.CustomFragmentPageAdapterScollview7;

public class IconTextTabsActivity7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new CustomFragmentPageAdapterScollview7(getChildFragmentManager()));
