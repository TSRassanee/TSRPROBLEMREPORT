...
public class HomeFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView1.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity3.class.getSimpleName(), "namethai"));
        textView2.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity3.class.getSimpleName(),"position"));
        boss.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity3.class.getSimpleName(), "linemanager"));
        namegroub.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity3.class.getSimpleName(),"name_linemanager"));
        // textView1.setText("aaa");

        urlNavHeaderBg=ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity3.class.getSimpleName(),"backgroud");
        urlProfileImg=ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity3.class.getSimpleName(),"picture");
