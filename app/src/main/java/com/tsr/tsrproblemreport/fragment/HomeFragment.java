    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      textView1 = (TextView) view.findViewById(R.id.txtname_intro);
       ...
       // gg= ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity.class.getSimpleName(),"ggg");
        textView1.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity.class.getSimpleName(), "namethai"));
        textView2.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity.class.getSimpleName(),"position"));
        boss.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity.class.getSimpleName(), "teamleader"));
        namegroub.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity.class.getSimpleName(),"name_teamleader"));
       // textView1.setText("aaa");

        urlNavHeaderBg=ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity.class.getSimpleName(),"backgroud");
        urlProfileImg=ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity.class.getSimpleName(),"picture");
