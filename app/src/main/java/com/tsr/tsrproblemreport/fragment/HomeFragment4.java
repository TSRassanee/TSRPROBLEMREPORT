...
public class HomeFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView1.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity4.class.getSimpleName(), "namethai"));
        textView2.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity4.class.getSimpleName(),"position"));
        ...
        urlNavHeaderBg=ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity4.class.getSimpleName(),"backgroud");
        urlProfileImg=ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity4.class.getSimpleName(),"picture");
