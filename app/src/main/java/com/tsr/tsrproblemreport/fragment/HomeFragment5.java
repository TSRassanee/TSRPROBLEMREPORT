...
public class HomeFragment5 extends Fragment {
    ...
    TextView textView1,textView2,boss,namegroub,textView12;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView1.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity5.class.getSimpleName(), "namethai"));
        textView2.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity5.class.getSimpleName(),"position"));
       // boss.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity4.class.getSimpleName(), "salemanager"));
       // namegroub.setText(ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity4.class.getSimpleName(),"name_salemanager"));
        // textView1.setText("aaa");

        urlNavHeaderBg=ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity5.class.getSimpleName(),"backgroud");
        urlProfileImg=ManageSharedPreferences.LoadPreferences(getActivity(),MusicActivity5.class.getSimpleName(),"picture");
